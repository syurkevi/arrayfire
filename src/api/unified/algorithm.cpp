...
af_err af_func(af_array *keys_out, af_array *vals_out, const af_array keys, const af_array vals, const int dim) \
{ \
    CHECK_ARRAYS(keys); \
    CHECK_ARRAYS(vals); \
...
af_err af_func_nan(af_array *keys_out, af_array *vals_out, const af_array keys, const af_array vals, const int dim, const double nanval) \
{ \
    CHECK_ARRAYS(keys); \
    CHECK_ARRAYS(vals); \
