...
{
    CHECK_ARRAYS(signal, filter);
    return CALL(out, signal, filter, stride_dims, strides, padding_dims, paddings, dilation_dims, dilations);
}
                            ...
                            af_conv_gradient_type gradType)
{
    ...
    return CALL(out, incoming_gradient, original_signal, original_filter, convolved_output,
                 stride_dims, strides, padding_dims, paddings, dilation_dims, dilations, gradType);
