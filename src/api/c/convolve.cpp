...
af_err af_convolve2_strided(af_array *out,
                            const af_array signal, const af_array filter,
...
af_err af_convolve2Gradient(af_array *out,
    ...
    try {
        ...
        switch(type) {
            case f32:
                output = conv2GradCall<float>(incoming_gradient,
                                              original_signal,
                                              original_filter,
                                              convolved_output,
                                              stride, padding, dilation,
                                              grad_type); break;
            case f64:
                output = conv2GradCall<double>(incoming_gradient,
                                               original_signal,
                                               original_filter,
                                               convolved_output,
                                               stride, padding, dilation,
                                               grad_type); break;
            case s32:
                output = conv2GradCall<int>(incoming_gradient,
                                            original_signal,
                                            original_filter,
                                            convolved_output,
                                            stride, padding, dilation,
                                            grad_type); break;
            case u32:
                output = conv2GradCall<uint>(incoming_gradient,
                                             original_signal,
                                             original_filter,
                                             convolved_output,
                                             stride, padding, dilation,
                                             grad_type); break;
            case s16:
                output = conv2GradCall<short>(incoming_gradient,
                                              original_signal,
                                              original_filter,
                                              convolved_output,
                                              stride, padding, dilation,
                                              grad_type); break;
            case u16:
                output = conv2GradCall<ushort>(incoming_gradient,
                                               original_signal,
                                               original_filter,
                                               convolved_output,
                                               stride, padding, dilation,
                                               grad_type); break;
            case u8:
                output = conv2GradCall<uchar>(incoming_gradient,
                                              original_signal,
                                              original_filter,
                                              convolved_output,
                                              stride, padding, dilation,
