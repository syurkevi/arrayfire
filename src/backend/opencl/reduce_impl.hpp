...
namespace opencl
{
    ...
    {
        kernel::reduce_by_key<op, Ti, Tk, To>(keys_out, vals_out, keys, vals, dim, change_nan, nanval);
    }
...
#define INSTANTIATE(Op, Ti, To)                                                                       \
    ...
    template void reduce_by_key<Op, Ti, int, To>(Array<int> &keys_out,   Array<To> &vals_out,         \
